...
export const BgPattern = React.memo(({ width = '100%', height = '100%' }: Props) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.0833333" stopColor="#abbdf9"></stop>
          <stop offset="0.364583" stopColor="#d2deff"></stop>
          <stop offset="0.658041" stopColor="#fff"></stop>
          <stop offset="0.798521" stopColor="#3e63dd"></stop>
          <stop offset="0.942708" stopColor="#fff"></stop>
        ...
        >
          <stop stopColor="#fff"></stop>
          <stop offset="0.0833333" stopColor="#f7f9ff"></stop>
          <stop offset="0.333803" stopColor="#fdfdfe"></stop>
          <stop offset="0.658041" stopColor="#fff"></stop>
          <stop offset="0.798521" stopColor="#8da4ef"></stop>
          <stop offset="0.942708" stopColor="#fff"></stop>
          <stop offset="1" stopColor="#fff"></stop>
        </radialGradient>
        <radialGradient
        ...
        >
          <stop stopColor="#fff"></stop>
          <stop offset="0.140625" stopColor="#edf2fe"></stop>
          <stop offset="0.333803" stopColor="#abbdf9"></stop>
          <stop offset="0.658041" stopColor="#fff"></stop>
          <stop offset="0.798521" stopColor="#8da4ef"></stop>
          <stop offset="0.942708" stopColor="#fff"></stop>
          <stop offset="1" stopColor="#fff"></stop>
